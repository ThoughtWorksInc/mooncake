...
(eh/test-translations "Internal server error page" (constantly (e/internal-server-error)))
(eh/test-translations "Not found error page" (constantly (e/not-found-error)))
(eh/test-translations "Forbidden error page" (constantly (e/forbidden-error)))
